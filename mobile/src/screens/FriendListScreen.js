...
const DUMMY_FRIENDS = [
    ...
    { id: '00000000-0000-0000-0000-000000000001', name: 'Alice Johnson (Dummy)', email: 'alice@example.com' },
    { id: '00000000-0000-0000-0000-000000000002', name: 'Bob Smith (Dummy)', email: 'bob@example.com' },
];
    ...
    const renderItem = ({ item }) => (
        <View style={styles.card}>
            ...
            <TouchableOpacity
                ...
                onPress={() => handleRequestLocation(item)}
            >
