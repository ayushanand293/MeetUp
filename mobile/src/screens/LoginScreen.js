  ...
  const handleEmailLogin = async () => {
    ...
    try {
      ...
      if (message.includes('Email not confirmed')) {
        message =
          'Please confirm your email address before signing in. Check your inbox (and spam) for a confirmation link.';
      } else if (message.includes('Invalid login credentials')) {
        message =
          'Invalid email or password. If you just signed up, make sure you clicked the confirmation link in your email.';
      }
